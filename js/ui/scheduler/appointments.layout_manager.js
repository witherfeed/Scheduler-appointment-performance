...
class AppointmentLayoutManager {
    ...
    createAppointmentsMap(items) {
        ...
        console.log('geometryTime', geometryTime);
        console.log('createAppointments', createAppointments);
        console.log('createGridAppointmentList', createGridAppointmentList);
        console.log('cropAppointmentsByStartDayHour', cropAppointmentsByStartDayHour);
